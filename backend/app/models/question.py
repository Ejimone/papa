...
class Question(Base):
    ...
    # Processing status (from user's version)
    ...
    question_metadata = relationship("QuestionMetadata", back_populates="question", uselist=False, cascade="all, delete-orphan")
...
class QuestionMetadata(Base):
    ...
    # Relationships
    question = relationship("Question", back_populates="question_metadata")
