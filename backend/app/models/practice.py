...
class UserProfile(Base):
    ...
    academic_level = Column(String(50), nullable=True)  # undergraduate, graduate, etc.
    university = Column(String(200), nullable=True)
    degree = Column(String(200), nullable=True)
    year = Column(String(20), nullable=True)  # Freshman, Sophomore, etc.
    ...
    allow_comparison = Column(Boolean, default=True)
...
class UserPreferences(Base):
    ...
    preferred_difficulty = Column(String(50), default="adaptive")  # easy, medium, hard, adaptive
    preferred_session_length = Column(Integer, default=15)  # Minutes
    daily_question_goal = Column(Integer, default=10)
    study_reminder_time = Column(String(10), nullable=True)  # "09:00" format
    
    # Question preferences
    question_types = Column(JSON, default=list)  # Preferred question types
    subjects_of_interest = Column(JSON, default=list)  # Subject IDs
    exclude_mastered = Column(Boolean, default=False)
    ...
    hint_system_enabled = Column(Boolean, default=True)
    ...
    spaced_repetition = Column(Boolean, default=True)
    adaptive_difficulty = Column(Boolean, default=True)
    time_pressure_mode = Column(Boolean, default=False)
